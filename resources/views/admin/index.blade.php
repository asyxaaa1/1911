    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="{{'admin/index_v1'}}">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('/test/index')}}">新闻添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('/test/show')}}">新闻列表</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('/code/code_add')}}">渠道添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('/code/code_index')}}">渠道列表</a>
                        </li>
                    </ul>
                </li>
            </ul>
